...
public:
    ...
    inline string   CPPName() const             { return m_cppName; }
    inline string   QualifiedName() const       { return m_qualifiedName; }
    inline string   CPPQualifiedName() const    { return m_cppQualifiedName; }
...
protected:
    void SetCPPName(const string& cppName);
    void SetQualifiedName(const string& qualified);
    void SetCPPQualifiedName();
